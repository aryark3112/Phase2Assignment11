        ...
        <table class="w-100">
            <tr>
                ...
                <td class="auto-style3">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ContentDBConnectionString2 %>" ProviderName="<%$ ConnectionStrings:ContentDBConnectionString2.ProviderName %>" SelectCommand="SELECT * FROM [Articles]"></asp:SqlDataSource>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
